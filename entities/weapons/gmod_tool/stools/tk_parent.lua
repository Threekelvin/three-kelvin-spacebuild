...
function TOOL:CanSelectEnt(trace)
    ...
    if SERVER && !IsValid(trace.Entity:GetPhysicsObject()) then return false end
    return true
end
...
function TOOL.BuildCPanel(CPanel)
    ...
    CPanel:AddControl("header", {description = "#tool.tk_parent.desc"})

    CPanel:AddControl("checkbox", {label = "Enable Physics", command = "tk_parent_physics"})

    CPanel:AddControl("checkbox", {label = "Mass Balance", command = "tk_parent_mass"})

    CPanel:AddControl("checkbox", {label = "Push Away Collision Mode", command = "tk_parent_pushaway"})
