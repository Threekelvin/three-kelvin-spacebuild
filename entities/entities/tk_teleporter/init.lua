...
include("shared.lua")
util.AddNetworkString("3k_teleporter_open")
...
concommand.Add("3k_teleporter_send", function(ply, cmd, args)
    ...
    if not IsValid(ply) or not IsValid(ent) or ent:GetClass() ~= "tk_teleporter" then return end
