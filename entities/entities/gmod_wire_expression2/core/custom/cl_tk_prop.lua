...
E2Helper.Descriptions["propSpawn"] = "Use the model string || a template entity to spawn a prop.\nYou can set the position &&/|| the rotation as well.\nThe last number indicates frozen/unfrozen."
...
E2Helper.Descriptions["parentTo"] = "Superparents one entity to another."
