function EFFECT:Init(data)
    ...
    for i = 1,  512 do
        ...
        if part then
            ...
            if math.Distance(0, 0, part:GetVelocity().x, part:GetVelocity().y) >= 1500 then
                part:SetStartSize((math.Distance(0, 0, part:GetVelocity().x, part:GetVelocity().y) - 1600) / 4)
                part:SetEndSize(math.Distance(0, 0, part:GetVelocity().x, part:GetVelocity().y) - 1600)
            else
                part:SetStartSize(0)
                part:SetEndSize(0)
            end
    ...
    for i = 1,  512 do
        ...
        if part1 then
            ...
            part1:SetStartSize(150 - (math.Distance(0, 0, part1:GetVelocity().x, part1:GetVelocity().y)) / 16)
            part1:SetEndSize(600 - (math.Distance(0, 0, part1:GetVelocity().x, part1:GetVelocity().y)) / 4)
