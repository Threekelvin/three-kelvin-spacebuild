<html>
	...
	<?php
		...
		$result = mysql_query("SELECT nick_name, team, score, playtime FROM server_player_record, player_stats WHERE server_player_record.steamid = player_stats.steamid ORDER BY score DESC LIMIT 20");
