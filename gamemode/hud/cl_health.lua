...
Hud.font = "TKFont18"
Hud.verticies = {}
Hud.mats = {Material("icon18/heart.png"),  Material("icon18/lightning.png"),  Material("icon18/leaf.png"),  Material("icon18/water.png")}
...
function Hud:RotateVerticies(angle)
    ...
    -- Correction for bottom screen edge.
    local centerY = center.y - 1
