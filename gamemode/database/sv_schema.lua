...
local threekelvin = {
    server_ban_data = {
        ...
        adm_steamid                 =   {"VARCHAR(20)", type = "string"},
        adm_ip                      =   {"VARCHAR(40)", type = "string"},
    },
    server_donations = {
        idx                         =   {"INT", "PRIMARY KEY", "AUTO_INCREMENT", type = "number"},
        steamid                     =   {"VARCHAR(20)", "NOT NULL", type = "string"},
        time                        =   {"INT", "DEFAULT 0", "NOT NULL", type = "number"},
        amount                      =   {"INT", "DEFAULT 0", type = "number"}
    },
    server_globalchat = {
        ...
        msg_flag                    =   {"TINYINT", "DEFAULT 0", type = "number"},
        msg_data                    =   {"LONGBLOB", type = "string"},
        sender_rank                 =   {"TINYINT", "DEFAULT 1", type = "number"},
        sender_faction              =   {"TINYINT", "DEFAULT 1", type = "number"},
        sender_name                 =   {"VARCHAR(127)", type = "string"}
    },
    server_player_record = {
        steamid                     =   {"VARCHAR(20)", "NOT NULL", "PRIMARY KEY", type = "string"},
        ip                          =   {"VARCHAR(40)", "NOT NULL", type = "string"},
        uniqueid                    =   {"VARCHAR(10)", "NOT NULL", type = "string"},
        steam_name                  =   {"VARCHAR(127)", "NOT NULL", type = "string"},
        nick_name                   =   {"VARCHAR(127)", "NOT NULL", type = "string"},
        rank                        =   {"TINYINT", "DEFAULT 1", type = "number"},
        team                        =   {"TINYINT", "DEFAULT 1", type = "number"},
    },
    player_stats = {
        steamid                     =   {"VARCHAR(20)", "NOT NULL", "PRIMARY KEY", type = "string", no_sync = true},
        playtime                    =   {"INT", "DEFAULT 0", type = "number", no_sync = true},
        score                       =   {"FLOAT", "DEFAULT 0", type = "number", no_sync = true}
    },
    player_settings = {
        steamid                     =   {"VARCHAR(20)", "NOT NULL", "PRIMARY KEY", type = "string", no_sync = true},
        captcha                     =   {"VARCHAR(127)", "DEFAULT 'abcde'", type = "string", no_sync = true},
    },
