...
local Queries = {
	create = {
		...
		player_team(
			...
			team3_points INT DEFAULT 0,
			team4_points INT DEFAULT 0
		)]],

        player_loadout = [[CREATE TABLE IF NOT EXISTS
        player_loadout(
            steamid VARCHAR(20) NOT NULL PRIMARY KEY,
            slot_m1 INT DEFAULT 0,
            slot_m1_locked TINYINT DEFAULT 0,
            slot_m2 INT DEFAULT 0,
            slot_m2_locked TINYINT DEFAULT 1,
            slot_m3 INT DEFAULT 0,
            slot_m3_locked TINYINT DEFAULT 1,
            slot_m4 INT DEFAULT 0,
            slot_m4_locked TINYINT DEFAULT 1,
            slot_m5 INT DEFAULT 0,
            slot_m5_locked TINYINT DEFAULT 1,
            slot_m6 INT DEFAULT 0,
            slot_m6_locked TINYINT DEFAULT 1,
            slot_s1 INT DEFAULT 0,
            slot_s1_locked TINYINT DEFAULT 0,
            slot_s2 INT DEFAULT 0,
            slot_s2_locked TINYINT DEFAULT 1,
            slot_s3 INT DEFAULT 0,
            slot_s3_locked TINYINT DEFAULT 1,
            slot_s4 INT DEFAULT 0,
            slot_s4_locked TINYINT DEFAULT 1,
            slot_s5 INT DEFAULT 0,
            slot_s5_locked TINYINT DEFAULT 1,
            slot_s6 INT DEFAULT 0,
            slot_s6_locked TINYINT DEFAULT 1,
            slot_w1 INT DEFAULT 0,
            slot_w1_locked TINYINT DEFAULT 0,
            slot_w2 INT DEFAULT 0,
            slot_w2_locked TINYINT DEFAULT 1,
            slot_w3 INT DEFAULT 0,
            slot_w3_locked TINYINT DEFAULT 1,
            slot_w4 INT DEFAULT 0,
            slot_w4_locked TINYINT DEFAULT 1,
            slot_w5 INT DEFAULT 0,
            slot_w5_locked TINYINT DEFAULT 1,
            slot_w6 INT DEFAULT 0,
            slot_w6_locked TINYINT DEFAULT 1
        )]],
...
function TK.DB:MakePlayerData(ply)
	local data = {}
	data.player_info = {
		name = ply:GetName(),
		playtime = 0,
